$(document).ready(function(){
  //alert('Hello World!');
  // Valitaan kaikki form-elementit, joihin liittyy destroy-form-luokka ja lisätään 
  // niihin kuuntelija, joka kutsuu parametrina annettua funktiota, kun lomake lähetetään
